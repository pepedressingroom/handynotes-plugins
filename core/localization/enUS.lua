...
L['options_rep_rewards'] = 'Show rep rewards'
...
L['options_skinning_rewards'] = 'Show skinning rewards'
L['options_skinning_rewards_desc'] = 'Display skinning rewards in tooltips and track their collected status.'
