...
L['options_skinning_rewards'] = 'Mostrar recompensas de desollamiento'
L['options_skinning_rewards_desc'] = 'Muestra las recompensas de desollamiento en los tooltip y sigue si lo has recogido.'
