...
L['hnj_northern_thaldraszus_hunt'] = '{note:Notiz: Wenn die Große Jagd beginnt solltest du schnellst möglich zu ihm, da er sonst von wilden Tieren getötet wird.}'
...
L['pretty_neat_note_blazewing'] = 'Kann während der Begegnung mit {npc:189901} im Dungeon {location:Neltharus} gefunden werden.'
...
L['creature_bait'] = 'Köder für Kreaturen'
...
L['options_icons_elusive_creature_desc'] = 'Zeigt die Positionen der scheuen Kreaturen an, die mit {item:193906} angelockt werden können.'
...
L['pepper_hammer_note'] = 'Sammel {object:Baumharz} und benutze dann den {object:Stock}, um {npc:195373} anzulocken.\n\n{bug:(BUG: Um den Stock anzuklicken könnte ein reload nötig sein)}'
...
L['pt_ench_faintly_enchanted_remains_note'] = 'Klicke die {object:Manaentzogene Kristallformation} an, um einen Gegner erscheinen zu lassen und besiege diesen. Dann plündere den Kristall, der erscheint.'
...
L['fdt_crystalline_flower'] = 'Kristalline Blume'
L['fdt_ancient_stone'] = 'Uralter Stein'
L['fdt_emerald_chest'] = 'Smaragdtruhe'
...
L['pt_smith_ancient_spear_shards_note'] = 'In einer Höhle westlich vom {location:Rusza\'thar-Vorstoß}.'
...
L['ancestor_note'] = 'Hol dir in einem Zelt am {location:Baumschrittaußenposten} von der {object:Essenz des Erwachens} den Stärkungszauber {spell:369277} (1 Stunde), um den Vorfahren zu sehen und biete ihm den benötigten Gegenstand an.'
...
L['shadeslash_note'] = 'Klicke den {object:Gestohlener Globus}, das {object:Gestohlenes Teleskop} und dann auf den {object:Gestohlener Fokus}, um den seltenen Gegner erscheinen zu lassen.'
...
L['lost_obsidian_cache'] = 'Verlorene Obsidiantruhe'
L['lost_obsidian_cache_step1'] = '1. Sammle {item:194122} auf dem Boden neben der {npc:186763}.'
L['lost_obsidian_cache_step2'] = '2. Wirf {item:194122} auf die {npc:191851} und fliege mit ihr zum Höhleneingang.'
L['lost_obsidian_cache_step3'] = '3. Plündere den {item:198085} vom {object:Verlorener Truhenschlüssel} am Höhleneingang und öffne damit die {object:Verlorene Obsidiantruhe} weiter hinten in der Höhle, um das Spielzeug zu erhalten.'
...
L['pt_alch_well_insulated_mug_note'] = 'In der {location:Drachenfluchfestung} zwischen einigen Elitegegnern.'
...
L['complaint_to_scalepiercer_note'] = 'Klicke die {object:Steintafel} im Inneren der Hütte an (auf der linken Seite hinten).'
L['grand_flames_journal_note'] = 'Klicke die {object:Steintafel} draußen hinter der Hütte an.'
L['wyrmeaters_recipe_note'] = 'Klicke die {object:Steintafel} im Inneren der Hütte an (auf der linken Seite).'
...
L['all_sides_of_the_story_veritistrasz_note'] = 'Beginne die Quest {quest:70132} und höre dir alle Geschichten von {npc:194076} an.\nDanach schaltest du die Quest {quest:70134} und die Folgequest {quest:70268} frei.\n\nFür die letze Quest benötigst du das {item:198661} welches in der {location:Drachenfluchfestung} zu finden ist.'

L['slumbering_worldsnail_note1'] = [[
1. Sammle 30x {item:191251} und 3x {item:193201} von Gegnern bei der {location:Obsidianzitadelle}, um einen {item:191264} herzustellen.
...
3. Benutze die Mitgliedschaft und sammle 1000x {item:202173} von Gegnern bei der {location:Obsidianzitadelle}, während der Schwächungszauber {spell:386848} aktiv ist.
...
L['otto_note_item3'] = 'Angle 1x {item:202074}, ein seltener Fisch der in den Gewässern bei der {location:Akademie von Algeth\'ar} geangelt werden kann. Wenn du die Königsfinne mit dem Fass benutzt, erhältst du ein {item:202069}.'
