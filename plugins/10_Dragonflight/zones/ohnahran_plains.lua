...
map.nodes[60407140] = PrettyNeat({
    ...
    pois = {
        Path({
            65176385, 65306268, 65446098, 65675976, 66305845, 67395686,
            67825637, 68475665, 68825624, 68665561, 68275465, 68495401,
            68715271, 68475139, 68235118, 67605108, 67355126, 67015196,
            66985233, 67515356, 67985417, 68515415, 68815420, 69085482,
            68945597, 68835656, 68215651, 67575664, 67105807, 66905925,
            67176100, 67196289, 65946405, 65236654, 64516886, 63556972,
            62646975, 61377047, 60587133, 59437110, 58567081, 58087066,
            57967121, 58147190, 57877357, 57957416, 58367469, 60427576,
            61927583, 62957660, 63277645, 64047574, 65477397, 66537400,
            67007326, 66847289, 65767138, 65447064, 65266930, 65236606,
            65436473, 65176385
        })
    }
}) -- Nergazurai
...
map.nodes[55005500] = ElusiveCreature({
    ...
    rewards = {
        Skin({item = 193224, count = 3}), -- Lustrous Scaled Hide
        Skin({item = 193253, count = 3}), -- Cacophonous Thunderscale
...
map.nodes[24005600] = ElusiveCreature({
    ...
    rewards = {
        Skin({item = 193218, count = 3}), -- Dense Hide
        Skin({item = 193251, count = 3}), -- Crystalspine Fur
...
map.nodes[75456924] = ns.node.FyrakkAssault({
    label = '{quest:74501}', -- Suffusion Camp: Cinderwind
    interval = ns.Intervals.FyrakkAssaultInterval({id = 0})
})

map.nodes[76156952] = ns.node.DiscipleOfFyrakk({
    id = 201673, -- Kretchenwrath
    vignette = 5611,
    interval = ns.Intervals.FyrakkAssaultInterval({id = 0})
})

map.nodes[73777248] = ns.node.SecuredShipment({
    quest = 75525,
    interval = ns.Intervals.FyrakkAssaultInterval({id = 0})
})
...
map.nodes[72277242] = Node({
    ...
    IsEnabled = function(self) -- Blacksmithing
        ...
        return ns.Interval.IsActive(self.interval)
    end
}) -- Shadowflame Forge
...
map.nodes[64164161] = ns.node.Celestine({
    interval = ns.Intervals.DreamSurgeInterval({id = 1})
})
